...
from compy_cli.src.transpilers.other.transpiler.maps.d_types import FnArgByValueMapValue
from compy_cli.src.transpilers.other.transpiler.module.mapping.util import is_one
