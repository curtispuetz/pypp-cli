...
from compy_cli.src.transpilers.other.transpiler.module.handle_stmt.h_class_def.for_class.calc_constructor_sig import (  # noqa: E501
    calc_constructor_signature_for_class,
)
from compy_cli.src.transpilers.other.transpiler.module.handle_stmt.h_class_def.util import (
    ClassMethod,
    calc_method,
    ClassField,
    calc_class_field,
...
from compy_cli.src.transpilers.other.transpiler.module.util.calc_fn_signature import (
    calc_fn_arg_types,
)
