...
from compy_cli.src.transpilers.other.transpiler.module.handle_expr.h_comp import (
    handle_comp,
)
...
from compy_cli.src.transpilers.other.transpiler.module.mapping.util import (
    calc_string_fn,
    find_map_entry,
)
from compy_cli.src.transpilers.other.transpiler.module.util.calc_callable_type import (
    calc_callable_type,
)
...
from compy_cli.src.transpilers.other.transpiler.module.util.calc_ref_string import (
    calc_ref_str,
)
