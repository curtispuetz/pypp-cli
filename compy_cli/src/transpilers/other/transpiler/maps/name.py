...
NAME_MAP: NameMap = {
    ...
    "float32": {
        PySpecificImpFrom("compy_python", "float32"): ToStringEntry(
            "float", []
        )
    },
    "int8_t": {
        PySpecificImpFrom("compy_python", "int8_t"): ToStringEntry(
            "int8_t",
            [AngInc("cstdint")],
        )
    },
    "int16_t": {
        PySpecificImpFrom("compy_python", "int16_t"): ToStringEntry(
            "int16_t",
            [AngInc("cstdint")],
        )
    },
    "int32_t": {
        PySpecificImpFrom("compy_python", "int32_t"): ToStringEntry(
            "int32_t",
            [AngInc("cstdint")],
        )
    },
    "int64_t": {
        PySpecificImpFrom("compy_python", "int64_t"): ToStringEntry(
            "int64_t",
            [AngInc("cstdint")],
        )
    },
    "uint8_t": {
        PySpecificImpFrom("compy_python", "uint8_t"): ToStringEntry(
            "uint8_t", [AngInc("cstdint")]
        )
    },
    "uint16_t": {
        PySpecificImpFrom("compy_python", "uint16_t"): ToStringEntry(
            "uint16_t", [AngInc("cstdint")]
        )
    },
    "uint32_t": {
        PySpecificImpFrom("compy_python", "uint32_t"): ToStringEntry(
            "uint32_t", [AngInc("cstdint")]
        )
    },
    "uint64_t": {
        PySpecificImpFrom("compy_python", "uint64_t"): ToStringEntry(
    ...
    "Uni": {
        PySpecificImpFrom("compy_python", "Uni"): ToStringEntry(
