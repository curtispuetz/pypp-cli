...
from compy_cli.src.transpilers.other.transpiler.maps.ann_assign import (
    ANN_ASSIGN_MAP,
)
from compy_cli.src.transpilers.other.transpiler.maps.attr import (
    ATTR_CALC_ENTRY_FN_MAP,
    ATTR_MAP,
)
from compy_cli.src.transpilers.other.transpiler.maps.call.call import (
    CALL_CALC_ENTRY_FN_MAP,
    CALL_MAP,
)
from compy_cli.src.transpilers.other.transpiler.maps.fn_arg_passed_by_value import (
...
from compy_cli.src.transpilers.other.transpiler.maps.name import NAME_MAP
...
from compy_cli.src.transpilers.other.transpiler.maps.subscriptable_types import (
