...
from compy_cli.src.transpilers.other.module.handle_expr.h_comp import handle_comp
...
from compy_cli.src.transpilers.other.module.util.calc_callable_type import (
    calc_callable_type,
)
from compy_cli.src.transpilers.other.module.util.inner_strings import (
    calc_inside_ang,
    calc_inside_rd,
)
from compy_cli.src.transpilers.other.module.util.calc_ref_string import calc_ref_str
