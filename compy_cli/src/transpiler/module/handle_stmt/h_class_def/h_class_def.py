...
from compy_cli.src.transpiler.module.handle_stmt.h_class_def.for_dataclasses.for_dataclasses import (  # noqa: E501
    handle_class_def_for_dataclass,
)
from compy_cli.src.transpiler.module.handle_stmt.h_class_def.for_exception import (
    handle_class_def_for_exception,
)
from compy_cli.src.transpiler.module.handle_stmt.h_class_def.for_interface.for_interface import (  # noqa: E501
