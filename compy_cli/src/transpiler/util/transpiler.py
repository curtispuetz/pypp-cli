...
class Transpiler:
    def __init__(self, d: TranspilerDeps) -> None:
        self._d = d
        self._helper = _TranspilerHelper(self._d)
    ...
    def transpile_all_changed_files(
        ...
        self._helper.transpile_all_changed_files(
            new_files, changed_files, is_main_files
        )
...
class _TranspilerHelper:
    ...
    def _transpile_cpp_and_h_files(
        ...
        py_src_file: Path = self._d.python_src_dir / changed_or_new_file
        ...
        cpp_full_path: Path = self._d.cpp_src_dir / cpp_file
        ...
        h_full_path: Path = self._d.cpp_src_dir / h_file
    ...
    def _transpile_cpp_files_for_main(
        ...
        py_main_file: Path = self._d.python_dir / changed_or_new_file
        ...
        new_file: Path = self._d.cpp_dir / new_file_rel
