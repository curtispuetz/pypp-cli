...
void numpy_arrays_fn() {
    ...
    c.print();
    pypp_np::zeros<double>(PyList({2, 3})).print();
    pypp_np::zeros<int16_t>(PyList({2, 3})).print();
    pypp_np::zeros<uint16_t>(PyList({2, 3})).print();
    pypp_np::zeros<int32_t>(PyList({2, 3})).print();
    pypp_np::zeros<uint64_t>(PyList({2, 3})).print();
    pypp_np::zeros<unsigned int>(PyList({2, 3})).print();
    pypp_np::zeros<long double>(PyList({2, 3})).print();
    pypp_np::zeros<bool>(PyList({2, 3})).print();
    pypp_np::ones<bool>(PyList({2, 3})).print();
