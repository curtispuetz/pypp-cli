...
void list_fn() {
    ...
    a.reverse();
    pypp::print(a);
    pypp::print(pypp::str(a.count(2)));
    pypp::print(pypp::str(a.index(2)));
    a.remove(2);
    pypp::print(a);
    a.insert(4, 2);
    pypp::print(a);
    ...
    pypp::print(pypp::str(popped_val));
    pypp::print(a);
    int popped_val2 = a.pop(1);
    pypp::print(pypp::str(popped_val2));
    pypp::print(a);
    a.clear();
    pypp::print(a);
    pypp::print(pypp::str(pypp::PyList({1, 2}) == pypp::PyList({1, 2})));
    pypp::print(pypp::str(pypp::PyList({1, 2}) < pypp::PyList({1, 2})));
    pypp::print(pypp::str(pypp::PyList({1, 2}) <= pypp::PyList({1, 2})));
    pypp::print(pypp::str(pypp::PyList({1, 2}) > pypp::PyList({1, 2})));
    pypp::print(pypp::str(pypp::PyList({1, 2}) >= pypp::PyList({1, 2})));
